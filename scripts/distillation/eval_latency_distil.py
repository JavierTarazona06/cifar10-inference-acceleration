"""
J4-15/16 | Measure GPU latency (FP32) for distilled MobileNetV3-Small

Benchmark latency of the distilled student on CIFAR-10 test set.
- Batch size = 1
- Warm-up + measurement (mean + p95)
- Inputs on GPU
...
# Add src to path (scripts/distillation → project/src)
